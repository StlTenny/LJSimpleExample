...
- (void)loadView{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad){
        buyNow = [[LoopJoyStore sharedInstance] getLJButtonForItem:53 withButtonType:LJ_BUTTON_IPAD_RED];
    }
    else{
...
- (void)viewDidLoad
{
    ...
    //Make sure to change item number to one provided
    UIAlertView *ljAlert = [[LoopJoyStore sharedInstance] getLJAlertForItem:52
